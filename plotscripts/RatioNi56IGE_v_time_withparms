...
plt.plot( data21[0], mass21/IGE21, color = 'b')
plt.plot( data22[0], mass22/IGE22, color = 'b')
plt.plot( data23[0], mass23/IGE23, color = 'b')
plt.plot( data24[0], mass24/IGE24, color = 'b')
plt.plot( data25[0], mass25/IGE25, color = 'b')
plt.plot( data26[0], mass26/IGE26, color = 'b')
plt.plot( data27[0], mass27/IGE27, color = 'b')
plt.plot( data28[0], mass28/IGE28, color = 'b')
plt.plot( data29[0], mass29/IGE29, color = 'b')
plt.plot( data30[0], mass30/IGE30, color = 'b')

plt.plot( data21HY[0], mass21HY/IGE21HY, color = 'r')
plt.plot( data22HY[0], mass22HY/IGE22HY, color = 'r')
plt.plot( data23HY[0], mass23HY/IGE23HY, color = 'r')
plt.plot( data24HY[0], mass24HY/IGE24HY, color = 'r')
plt.plot( data25HY[0], mass25HY/IGE25HY, color = 'r')
plt.plot( data26HY[0], mass26HY/IGE26HY, color = 'r')
plt.plot( data27HY[0], mass27HY/IGE27HY, color = 'r')
plt.plot( data28HY[0], mass28HY/IGE28HY, color = 'r')
plt.plot( data29HY[0], mass29HY/IGE29HY, color = 'r')
plt.plot( data30HY[0], mass30HY/IGE30HY, color = 'r')




plt.ylabel('Ratio of Ni56 to IGE Masses')
plt.xlabel('Time (s)')
plt.tight_layout()
