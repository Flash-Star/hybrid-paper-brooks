...
A hybrid WD can then become a progenitor of a thermonuclear supernova.
The hybrid could be part of a binary system in which the companion star becomes
...
mergers where one member is a hybrid~\citep{yungelsonkuranov2017}. If, on the other hand, the hybrid
...
{\color{blue} Radial} temperature, density, and  composition profiles of the one-dimensional hybrid
...
so both the hybrid and {\color{blue} C-O}  models could share the same
	central ignition initial conditions {\color{blue} in our simulations}.
}
\end{figure}
