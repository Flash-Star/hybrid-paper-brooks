...
Assuming a hybrid WD forms, there is subsequent evolution that will occur.


\citep{schwabgaraud2018}
...
see however~\cite{lecoanetetal16}
...
Give a read to see! Reading says no, but confirm.


Also, recent population synthesis work indicating a substantial contribution
to the Ia population rate from mergers where one member is a 
hybrid~\citep{yungelsonkuranov2017}.


Explosions from hybrid models \citet{kromeretal2015,bravoetal2016,willcoxetal2016}
