...
to the traditional C/O progenitor leads to a lower average yield of $^{56}$Ni.
...
We also find that the C-O-Ne cases computed here produce a smaller fraction of iron group elements in the form of $^{56}$Ni than found previously,
a diferrence we attribute to both the central density and the location, center or off-center, of deflagration ignition.
\end{abstract}
...
The C-O model's composition consisted of \C{12}, \O{16}, and \Ne{22} in mass fractions 0.4, 0.57, and 0.02 respectively in the convective core and 0.5, 0.48, and 0.02 outside the convective core.
The C-O-Ne model used in flash had composition consisting of \C{12}, \O{16}, \Ne{20}, and \Ne{22}.
The mass fractions in the central convection zone were 0.14, 0.68, 0.23, and 0.05 respectively, and vary smoothly outside the convectiov zone as shown in Figure~\ref{fig:init_conds}.
...
This assumption allows the fraction of IGEs in the form of $^{56}$Ni to be estimated from the $Y_e$ tracked by the burning model.
...
{\color{red} TODO: make table of average yields (like table 1 in \cite{willcoxetal2016}).}
...
On average, the CO model reaches the DDT phase sooner then the
hybrid model.
A few simulations ended early, but after reaching their final yields, due to problematic physical conditions in the fluff.
{\color{red}TODO: confirm.}
...
for C-O and C-O-Ne.  Similar rectangles found in W16 for a progenitor without
...
indicating less expansion during deflagration. The averages and standard deviations, $\sigma$, of both
the C-O and C-O-Ne suites along both axes are indicated by the shaded
regions with $\pm1\sigma$ widths.
Lighter shaded regions indicate the averages and standard deviations found by \citet{willcoxetal2016} for hybrid C-O-Ne progenitors that do not mix during cooling.
...
At moderate expansion, where the mass at high density is between around 1.0 to 1.1 M$_\odot$, the C-O models tend to yield greater IGE mass.
Following
...
At lower degrees of expansion, where there is around 1.2~M$_\odot$ of material at high densities, there appears to be little difference between the IGE yields of C-O and C-O-Ne progenetiors.
...
It does appear consistent with an extrapolation of their data and the two cases that did yield these higher masses at high density.
...
This results in more mass at high density in the mixed cases, leading to more similar IGE yields.
The most likely reason for the weaker expansion is the higher central density necessary to ignite carbon burning with the lower central carbon fraction resulting from mixing during cooling
...
The steepness of the relation between IGE yield and mass at high density is such that the mean IGE yield found here is more than 0.15~M$_\odot$ larger than that found in \citet{willcoxetal2016},
shown as lines for comparison.
This increase closes the gap, making the resulting IGE yields similar.

While the higher central density makes the IGE yields quite similar, the hybrid C-O-Ne WD still produces less $^{56}$Ni than a C-O WD at similar central densitiy.
...
While the mixed and unmixed progenitors have similar carbon fractions, the mixed progenitor explodes with a higher central density, as already mentioned.
Another difference is that the mixed progenitor here does not show the off-center shell ignition that was found previously for the unmixed progenitor.
Both of these appear to contribute to the difference in the final $^{56}$Ni yield.
...
a lower central density and CONe progenitor whose interior is not mixed
during cooling.
}
\end{figure}
...
found by \citet{willcoxetal2016}.
The results found here, in which the carbon-poor compositions have a lower fractional $^{56}$Ni yield, are more consistent with the expectation for a lower peak burning temperature with lower C abundance.
This movivates a closer inspection of how the $^{56}$Ni/IGE ratio evolves during the explosion.
...
The fraction, by mass, of IGE material expected to be in the form of $^{56}$Ni after freeze-out is shown in Figure \ref{fig:compare_ratio} as it evolves in time.
...
In that work, with a lower density progenitor with a deflagration ignited off-center, the C-O mostly showed a smaller fraction of IGE in the form of $^{56}$Ni through most of the deflagation phase.
That difference was then closed during the detonation phase, to obtain similar ratios as seen in the lines above in Figure~\ref{fig:conversion}.
A similar effect happens here during the detonation phase, but the fraction of material that is $^{56}$Ni stays higher for the C-O progenitors.
...
Remarkably, up to around 0.5 seconds, no $^{56}$Ni is expected to be produced by the C-O-Ne progenitor.
The comparison to the results of \citep{willcoxetal2016} indicate that the central ignition, in higher density regions, is important to this ignition.
...
In conclusion, we attribute the following major differences from the progenitor treated here, which is mixed during cooling and centrally ignited, compared to the case in \citet{willcoxetal2016} that did not mix while cooling:
The higher central density necessitated for ignition by the lower central carbon fraction leads to a higher production of IGE.
The higher central density also leads to stronger electron capture.
...
Here we find that electron capture is noticably enhanced in the C-O-Ne case compared to C-O at the same density and ignition location.
...
This is due to their being higher central density, and therefore more tightly bound.
At the same time, C-O-Ne explosions should show lower $^{56}$Ni yield due to enhanced electron capture during the deflagration.
