...
While the higher central density makes the IGE yields quite similar, the hybrid C-O-Ne WD still produces less $^{56}$Ni than a C-O WD at similar central density.
...
This motivates a closer inspection of how the $^{56}$Ni/IGE ratio evolves during the explosion.
...
In that work, with a lower density progenitor with a deflagration ignited off-center, the C-O mostly showed a smaller fraction of IGE in the form of $^{56}$Ni through most of the deflagration phase.
...
yield of the $^{56}$Ni, a proxy for brightness.  Our first conclusion
is that hybrid progenitors that have experienced mixing during accretion are 
viable progenitors for type Ia supernovae. $^{56}$Ni yields from simulations
...
\citep{willcoxetal2016} reported that compared to the unmixed
...
produced a smaller fraction of IGEs in the form of $^{56}$Ni than the unmixed hybrid case, 
