...
This contrast is in a similar direction but not as large as the difference between C-O and C-O-Ne progenitors seen in W16.

{\color{red} TODO: make table of average yields (like table 1 in W16).}
